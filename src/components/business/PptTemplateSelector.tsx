                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {templates.map((template, index) => (
                                        <div
                                            ...
                                            className={`border rounded-lg p-2 cursor-pointer hover:border-blue-500 ${templateId === template.templateId.toString() ? 'border-blue-500 ring-2 ring-blue-200' : 'border-gray-200'
                                                }`}
