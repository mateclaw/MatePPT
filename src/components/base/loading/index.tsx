...
const Loading = (
  { type = 'area', text }: ILoadingProps = { type: 'area', text: '' },
) => {
  return (
    <div className={`flex w-full justify-center items-center   ${type === 'app' ? 'h-full fixed left-0 top-0' : ''}`}>


      <div className="bg-white px-6 pb-4 pt-10 rounded-lg shadow-lg flex gap-4 flex-col  items-center justify-center">
        <Spin/>
