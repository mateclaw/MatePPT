...
const translation = {
  ...
  operation: {
    ...
    language: 'Language',
    languageMessage: 'Please enter language',
  ...
  menus: {
    ...
    'ppt.myWorks': 'My Works',
    'ppt.myTemplates': 'My Templates',
    'ppt.templateMarket': 'Template Market',
    // AI Digital Human sub menus
    // My Account sub menus
